                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                <?php
                                $privilegios = $admin->get_Privilegio();
                                $rows = count($privilegios);
                                for ($i = 0; $i < $rows; $i++){ ?>
                                    <tr>
                                        <td><?php echo $privilegios[$i][0] ?></td>
                                        <td><?php echo $privilegios[$i][1] ?></td>
                                    </tr>
                                    <?php }  ?>
                                </tbody>
                            </table>
                            <div class="form-group">
                                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                    <center>
                                        <input type=button value="Agregar Privilegios" class="btn btn-success" onclick = "location='formPriv.php'"/>
