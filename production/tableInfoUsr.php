                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                <?php
                                $infoUsers = $admin->get_InfoUsers();
                                $rows = count($infoUsers);
                                for ($i = 0; $i < $rows; $i++) {?>
                                    <tr>
                                        <td><?php echo $infoUsers[$i][0] ?></td>
                                        <td><?php echo $infoUsers[$i][1] ?></td>
                                        <td><?php echo $infoUsers[$i][2] ?></td>
                                        <td><?php echo $infoUsers[$i][3] ?></td>
                                        <td><?php echo $infoUsers[$i][4] ?></td>
                                        <td><?php echo $infoUsers[$i][5] ?></td>
                                        <td><?php echo $infoUsers[$i][6] ?></td>
                                        <td><?php echo $infoUsers[$i][7] ?></td>
                                        <td><?php echo $infoUsers[$i][10] ?></td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
                            <div class="form-group">
                                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                    <center>
                                        <input type=button value="Agregar" class="btn btn-success" onclick = "location='adduser'"/>
                                        <input type=button value="Modificar" class="btn btn-success" onclick = "location='modInfo'"/>
                                </div>
                            </div>
                        </div>
                    </div>
