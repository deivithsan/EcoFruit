    ...
    $(function () {
        $('#containerGraf').highcharts({
            ...
            series: [{
                ...
                name: 'Ventas Totales',
            <?php
            $ventasGlobal = $admin->get_ventasGlobales();
            $rows = count($ventasGlobal);
                ...
                data: [
                    ...
                    for ($i = 0; $i < $rows; $i++) {
                    ?>
                    ['<?php echo $ventasGlobal[$i][2] ?>', <?php echo $ventasGlobal[$i][1]; ?>],
                    <?php
                    }
                    ?>
                ]
    ...
    $(function () {
        $('#containerGraf2').highcharts({
            ...
            series: [{
                ...
                name: 'Ventas',
                <?php
                $ventasGlEn = $admin->get_ventasGlobalesEne();
                $ventasGlFeb = $admin->get_ventasGlobalesFeb();
                $ventasGlMar = $admin->get_ventasGlobalesMar();
                $ventasGlAbr = $admin->get_ventasGlobalesAbr();
                $ventasGlMay = $admin->get_ventasGlobalesMay();
                $ventasGlJun = $admin->get_ventasGlobalesJun();
                $ventasGlJul = $admin->get_ventasGlobalesJul();
                $ventasGlAgo = $admin->get_ventasGlobalesAgo();
                $ventasGlSep = $admin->get_ventasGlobalesSep();
                $ventasGlOct = $admin->get_ventasGlobalesOct();
                $ventasGlNov = $admin->get_ventasGlobalesNov();
                $ventasGlDic = $admin->get_ventasGlobalesDic();

                ?>
                data: [
                    ['Enero', <?php echo $ventasGlEn[0][0]; ?>],
                    ['Febrero', <?php echo $ventasGlFeb[0][0]; ?>],
                    ['Marzo', <?php echo $ventasGlMar[0][0]; ?>],
                    ['Abril', <?php echo $ventasGlAbr[0][0]; ?>],
                    ['Mayo', <?php echo $ventasGlMay[0][0]; ?>],
                    ['Junio', <?php echo $ventasGlJun[0][0]; ?>],
                    ['Julio', <?php echo $ventasGlJul[0][0]; ?>],
                    ['Agosto', <?php echo $ventasGlAgo[0][0]; ?>],
                    ['Septiembre', <?php echo $ventasGlSep[0][0]; ?>],
                    ['Octubre', <?php echo $ventasGlOct[0][0]; ?>],
                    ['Noviembre', <?php echo $ventasGlNov[0][0]; ?>],
                    ['Diciembre', <?php echo $ventasGlDic[0][0]; ?>]
                ]
            }]
        });
    });
