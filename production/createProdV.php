...
<html lang="en">
  <head>
    ...
    <title>Ingresar Productos a la Venta</title>
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select name="vendedoreslist">
                                                ...
                                                for ($i=0; $i<sizeof($vendedores); $i++){
                                                    ?>
                                                    <option value="<?php echo $vendedores[$i]["iduser"] ?>"><?php echo $vendedores[$i]["nombre"]; ?> <?php echo $vendedores[$i]["apellido"]; ?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                            <center>
                                                ...
                                                <input type=button value="Ver Productos en Venta" class="btn btn-success" onclick = "location='tableProDisp'"/>
                                        </div>
                                    </div>
                                </form>
                            </div>
